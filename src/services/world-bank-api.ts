...
export interface WorldBankApiV2PaginationInformation
  extends t.TypeOf<typeof worldBankApiV2PaginationInformationValidator> {}
export interface WorldBankApiV2CountryInformation
  extends t.TypeOf<typeof worldBankApiV2CountryInformationValidator> {}
export interface WorldBankApiV2CountryResponse
  extends t.TypeOf<typeof worldBankApiV2CountryResponseValidator> {}
export interface WorldBankApiV2IndicatorResponse
  extends t.TypeOf<typeof worldBankApiV2IndicatorResponseValidator> {}
