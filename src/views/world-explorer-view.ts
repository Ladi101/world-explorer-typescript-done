...
export class WorldExplorerHTMLView implements WorldExplorerView {
  ...
  private readonly _chartConfigurationForm: HTMLSelectElement;
  ...
  constructor() {
    ...
    if (!this._countrySelect) {
      throw new Error(
        "Could not initialise the view. The countrySelect element id was not found. Was the template changed?"
      );
    }
    ...
    if (!this._indicatorSelect) {
      throw new Error(
        "Could not initialise the view. The indicatorSelect element id was not found. Was the template changed?"
      );
    }
    ...
    if (!this._fromYearSelect) {
      throw new Error(
        "Could not initialise the view. The fromYearSelect element id was not found. Was the template changed?"
      );
    }
    ...
    if (!this._toYearSelect) {
      throw new Error(
        "Could not initialise the view. The toYearSelect element id was not found. Was the template changed?"
      );
    }
    ...
    if (!this._chartTypeSelect) {
      throw new Error(
        "Could not initialise the view. The chartTypeSelect element id was not found. Was the template changed?"
      );
    }
    ...
    if (!this._chartConfigurationForm) {
      throw new Error(
        "Could not initialise the view. The chartConfiguration element id was not found. Was the template changed?"
      );
    }
    ...
    if (!this._canvas) {
      throw new Error(
        "Could not initialize the view. The 'worldExploreChart' element id was not found. Was the template changed?"
      );
    }
  }
  ...
  getChartFormDetails(): {
    ...
    if (this._toYearSelect.checkValidity() === false) {
      ...
      return {
        error: "And end year must be selected"
      };
    }
    ...
    const fromYear = Number.parseInt(this._fromYearSelect.value, 0);
    const toYear = Number.parseInt(this._toYearSelect.value, 0);
